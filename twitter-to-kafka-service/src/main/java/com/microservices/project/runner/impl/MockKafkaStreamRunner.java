...
import com.microservices.project.exception.TwitterToKafkaServiceException;
...
public class MockKafkaStreamRunner implements StreamRunner {
    ...
    private static final String[] WORDS = new String[]{
            ...
            "leo", "arcu", "imperdiet", "vel", "enim", "vel", "tincidunt", "pellentesque", "leo"
    };
    ...
    private String getFormattedTweet(String[] keywords, int minTweetLength, int maxTweetLength) {
        ...
        return formatTweetAsJsonWithParams(params, tweet);
    }

    private static String formatTweetAsJsonWithParams(String[] params, String tweet) {
